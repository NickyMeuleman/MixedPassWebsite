...
export const Index = () => {
  ...
  const PasswordGen = () => {
    ...
    document.getElementById("special").value === "No" ||
    document.getElementById("special").value === "Add Special Characters"
      ? (charset =
            ...
            <div className="container">
              <h1>
                {Gen ? (
                  ...
                  <FaLockOpen className="ico" />
                )}{" "}
                MIXEDPASS
              </h1>
              <div className="nav">
                <select name="special" id="special">
                  <option value="Add Special Characters">
                ...
                <a
                  href="https://github.com/mixedbitmedia/MixedPassWebsite"
                ...
                <a
                  href="https://mixedbitmedia.com"
                  title="View Mixedbitmedia!"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FiGlobe />
              ...
              <div className="genPassContainer">
                {Gen ? (
                  <p style={{ color: "#32cd32", margin: "0 0 20px 0" }}>
                    <FaStar className="star" /> New password generated!{" "}
                    <FaStar className="star" />
                  </p>
                ) : (
                  <p>
                    Click the button below to generate a secure password! <br />{" "}
                ...
                {Gen ? (
                  <button
                    ...
                    className="btn"
                  >
                    <FaCopy className="ico" /> Copy To Clipboard!
                  </button>
                ) : null}
                <span>{Gen ? "|" : null}</span>
                <button
                  onClick={() => setPassword(PasswordGen())}
                  className="btn"
                >
                  {Gen ? "Generate New Password!" : "Generate Password!"}
                </button>
              </div>
            </div>
          </main>
